export interface TokenCardEntityModelDb {
  card_number: number;
  cvv: number;
...
export class TokenCardEntity {
  ...
  constructor(data: TokenCardEntityModelDb) {
  ...
  public static create(data: TokenCardEntityModelDb) {
    return new TokenCardEntity(data);
  }
